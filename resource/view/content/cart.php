					...
					<table class="table table-totals">
						...
						<tfoot>
							<tr>
								<td>Order Total</td>
								<td>
									<?= $GLOBALS['CURRENCY'] . " " . $grandTotal = round((($cartSubtotal + $tax) - @$_SESSION['SSCF_DISCOUNT_AMOUNT'])); ?>
								</td>
							</tr>
						</tfoot>
					</table>
					...
					<form action="" method="post">
						<div class="input-group">
							<select class="form-control" name="shipping_method">
								...
								<option value="50"> Inside of Peshawar </option>
								<option value="120"> Outside of Peshawar</option>
							</select>
							<div class="input-group-append">
