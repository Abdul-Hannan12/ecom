			...
			<script type="text/javascript">
				...
				function init() {
					...
					var mapOptions = {
						...
						center: new google.maps.LatLng(34.0151, 71.5249), // New York
			...
			<div class="col-md-4">
				...
				<div class="contact-info">
					<div>
						...
						<p><a href="tel:">+92 3307050105</a></p>
						<p>Cell Number</p>
					</div>
					<div>
					...
					<div>
						...
						<p><a href="mailto:#">ywrabdulwasay@gmail.com</a></p>
						<p><a href="mailto:#">haseeb@gmail.com</a></p>
					</div>
					<div>
						<i class="icon-skype"></i>
						<p><a href="">Abdul Wasay</a></p>
